(self["webpackChunkform_frontend"] = self["webpackChunkform_frontend"] || []).push([[228],{
...
__webpack_require__.d(__webpack_exports__, {
  "UT": () => (/* binding */ HashRouter),
  "rU": () => (/* binding */ Link)
});

// UNUSED EXPORTS: BrowserRouter, MemoryRouter, NavLink, Prompt, Redirect, Route, Router, StaticRouter, Switch, generatePath, matchPath, useHistory, useLocation, useParams, useRouteMatch, withRouter
...
function Redirect(_ref) {
  ...
  return react.createElement(context.Consumer, null, function (context) {
    ...
    var location = createLocation(computedMatch ? typeof to === "string" ? generatePath(to, computedMatch.params) : (0,esm_extends/* default */.Z)({}, to, {
    ...
    return react.createElement(Lifecycle, {
      ...
      onUpdate: function onUpdate(self, prevProps) {
        ...
        if (!locationsAreEqual(prevLocation, (0,esm_extends/* default */.Z)({}, location, {
