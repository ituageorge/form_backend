"use strict";
(self["webpackChunkform_frontend"] = self["webpackChunkform_frontend"] || []).push([[444],{
...
var UpdatePassword = function UpdatePassword() {
  var location = (0,react_router_dom__WEBPACK_IMPORTED_MODULE_3__/* .useLocation */ .TH)();
  ...
  var updateThePassword = function updateThePassword(e) {
    e.preventDefault();
    var userId = new URLSearchParams(location.search).get('userId');
    var accessToken = new URLSearchParams(location.search).get('accessToken');
  ...
  return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement("div", {
    className: " h-screen w-full flex flex-col items-center subpixel-antialiased text-2xl justify-center bg-gradient-to-r from-purple-500 to-pink-500"
  }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement("h3", {
    className: "pb-6"
  }, "Update your password"), submitted ? /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement("div", {
    className: "flex  text-left my-6"
  }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement("p", null, "Your password has been saved."), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement(react_router_dom__WEBPACK_IMPORTED_MODULE_4__/* .Link */ .rU, {
    to: "/login",
    className: "p-6"
  }, "Sign back in")) : /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement("div", {
    className: "flex flex-col items-center justify-center"
  }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement("form", {
    name: "form",
    className: "pb-4 flex flex-col items-center justify-center",
    onSubmit: updateThePassword // style={{ paddingBottom: "1.5rem" }}
    ...
    type: "password" // className="ghostInput"
    ,
    ...
    name: "confirm password" // className="ghostInput"

  }), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement("button", {
    type: "submit",
    className: "bg-gradient-to-r from-purple-500 to-pink-500 font-bold text-xl my-5 py-3 tracking-widest text-white  "
  }, "Update password"))));
};
